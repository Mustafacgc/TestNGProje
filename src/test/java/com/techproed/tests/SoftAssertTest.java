...
public class SoftAssertTest {
    /*
        ...
        SoftAssert kullaniminin Hard Assert kullanimindan farklari:
          1. SoftAssert'te eger test basarisizsa kalan kismi da calistiriyor.
    ...
    public void test01(){
        ...
        softAssert.assertAll(); //yukaridaki yaptigimiz tum dogrumalar
                                // basarili ise testimiz basarili, degil ise
                                // testimiz basarisizdir.
                                //HaardAssert gibi
    ...
    public void test02(){
        ...
        WebElement sifnInButton = driver.findElement(By.name("commit"));
        sifnInButton.click();
